...
| [0004 P02 controller dependency review](0004-controller-dependency-review-2026-09.md) | Proceed with the user-approved Rust controller/CLI dependency set; keep the shared core dependency-free and avoid bespoke protocol or cryptographic implementations | Accepted 2026-09-24 |
